  ...
  return (
    <div className="relative flex min-h-screen bg-slate-100 dark:bg-slate-950">
      ...
      <div className="flex w-full gap-3 py-4 px-1 sm:gap-4 sm:p-5 lg:gap-5 lg:p-6 xl:p-8">
        <aside className="sticky top-4 z-30 hidden h-[calc(100vh-2rem)] w-[280px] shrink-0 flex-col rounded-lg border border-slate-200/90 bg-white/85 py-6 shadow-xl shadow-slate-900/5 backdrop-blur-xl dark:border-slate-800/90 dark:bg-slate-950/80 sm:h-[calc(100vh-2.5rem)] lg:flex lg:h-[calc(100vh-3rem)] lg:w-[288px] xl:w-[300px]">
          <div className="px-4">
            <AdminBrandMark />
          </div>
        ...
        <div className="flex min-h-[calc(100vh-2rem)] min-w-0 flex-1 flex-col overflow-hidden rounded-lg border border-slate-200/80 bg-white/90 shadow-[0_8px_40px_-12px_rgba(15,23,42,0.12)] backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-900/50 dark:shadow-[0_8px_40px_-12px_rgba(0,0,0,0.4)] sm:min-h-[calc(100vh-2.5rem)] lg:min-h-[calc(100vh-3rem)]">
