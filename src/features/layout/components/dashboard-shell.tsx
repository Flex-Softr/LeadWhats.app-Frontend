  ...
  return (
    <div className="relative flex min-h-screen bg-slate-100 dark:bg-slate-950">
      ...
      <div className="flex w-full gap-3 p-4 sm:gap-4 sm:p-5 lg:gap-5 lg:p-6 xl:p-8">
        <AppSidebar />
        <div className="flex min-h-[calc(100vh-2rem)] min-w-0 flex-1 flex-col overflow-hidden rounded-[1.75rem] border border-white/60 bg-slate-50/80 shadow-[0_8px_40px_-12px_rgba(91,33,182,0.12)] backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-900/40 dark:shadow-[0_8px_40px_-12px_rgba(0,0,0,0.45)] sm:min-h-[calc(100vh-2.5rem)] lg:min-h-[calc(100vh-3rem)]">
          <AppHeader />
